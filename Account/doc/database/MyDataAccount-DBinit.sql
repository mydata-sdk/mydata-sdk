...
-- ma 13. maaliskuuta 2017 15.25.40
...
CREATE TABLE IF NOT EXISTS `MyDataAccount`.`RemoteIdentityProviders` (
  ...
  `Accounts_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_RemoteIdentityProviders_Accounts1_idx` (`Accounts_id` ASC),
  CONSTRAINT `fk_RemoteIdentityProviders_Accounts1`
    FOREIGN KEY (`Accounts_id`)
    REFERENCES `MyDataAccount`.`Accounts` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `MyDataAccount`.`OneTimeCookies` (
  ...
  INDEX `fk_OneTimeCookies_Accounts1_idx` (`Accounts_id` ASC),
  CONSTRAINT `fk_OneTimeCookies_LocalIdentities1`
    FOREIGN KEY (`LocalIdentities_id`)
    REFERENCES `MyDataAccount`.`LocalIdentities` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_OneTimeCookies_Accounts1`
    FOREIGN KEY (`Accounts_id`)
    REFERENCES `MyDataAccount`.`Accounts` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
