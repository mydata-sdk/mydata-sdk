...
account_api.add_resource(Account, '/api/accounts/<string:account_id>/', endpoint='account-get')
account_api.add_resource(AccountDelete, '/api/accounts/<string:account_id>/', endpoint='account-delete')
