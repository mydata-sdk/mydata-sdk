...
class SdkTestCase(unittest.TestCase):
    ...
    ##########
    ##########
    def test_for_account_fetch_consent_by_link_with_consent_pairs(self):
        """
        Test Consents
        :return: account_id, account_api_key, sdk_api_key, source_slr_id, source_ssr_id, sink_slr_id, sink_ssr_id
        """
        print_test_title(test_name="test_for_account_fetch_consent_by_link_with_consent_pairs")
